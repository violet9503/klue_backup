...
@Component({
  selector: 'mypage-report',
  templateUrl: './mypage-report.component.html',
  styleUrls: ['./mypage-report.component.css']
})
export class MypageReportComponent implements OnInit{
  alarmList:any[];
  pageList:number[] = [];
  currentPage:number;
  maxPage:number;
